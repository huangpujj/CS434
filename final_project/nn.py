...
def kFold(data_file, indice_file):
...
data, indice = kFold('./data/part1/Subject_2_part1.csv', './data/part1/list2_part1.csv')

train_set = DiabetesDataset(data, indice)
...
train_loader = DataLoader(dataset=train_set,
						  ...
						  num_workers=2)
'''
test_set = DiabetesDataset('./data/part1/Subject_7_part1.csv', './data/part1/list_7_part1.csv')
